...
export const downloadProton = async (downloadUrl) => {
  ...
  try {
    ...
    console.log("SUCCESS: Proton downloaded successfully!");
  } catch (error) {
    console.error("ERROR: Error downloading Proton:", error);
  } finally {
...
export const setProton = (protonBuild) => {
  ...
  try {
    ...
    console.log(`GOOD: Proton set to: ${protonBuild}`);
  } catch (error) {
    console.error("ERROR: Error setting Proton:", error);
  }
};
